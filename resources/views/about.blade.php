                ...
                <div class="major-caousel js-carousel-1 owl-carousel">              
                    <div class="row justify-content-center">
                        <div class="media d-block media-custom text-center m-3">
                            ...
                            <div class="media-body">
                                <h3 class="mt-0 text-black mt-2">Risma Kurniawaty</h3>
                        ...
                        <div class="media d-block media-custom text-center m-3">
                            ...
                            <div class="media-body">
                                <h3 class="mt-0 text-black mt-2">Faris Izzatur Rahman</h3>
                                <p class="lead">Mahasiswa Informatika</p>
                            </div>     
                        </div>   
                        <div class="media d-block media-custom text-center m-3">
                            ...
                            <div class="media-body">
                                <h3 class="mt-0 text-black mt-2">Zulfia Rahmi</h3>
                                <p class="lead">Mahasiswa Informatika</p>
                            </div>     
                        </div>   
                    </div>
                    <div class="row justify-content-center">
                        <div class="media d-block media-custom text-center m-3">
                            ...
                            <div class="media-body">
                                <h3 class="mt-0 text-black mt-2">Cut Meutia Haura</h3>
                                <p class="lead">Mahasiswa Informatika</p>
                            </div>     
                        </div>
                        <div class="media d-block media-custom text-center m-3">
                            ...
                            <div class="media-body">
                                <h3 class="mt-0 text-black mt-2">Desintha Zahara Azmi</h3>
                                <p class="lead">Mahasiswa Informatika</p>
                            </div>     
                        </div>
                        <div class="media d-block media-custom text-center m-3">
                            ...
                            <div class="media-body">
                                <h3 class="mt-0 text-black mt-2">Nafla Diva Syafia</h3>
                                <p class="lead">Mahasiswa Informatika</p>
                            </div>     
                        </div>
                    </div>
